...
public class activity_write extends AppCompatActivity {
    ...
    public void checkFunction(){
        ...
        if(permissioninfo == PackageManager.PERMISSION_GRANTED){
            Toast.makeText(this,"SDCard 쓰기 권한 있습니다.",Toast.LENGTH_SHORT).show();
        }else{
                ...
                if(everyshare.isChecked() || coupleshare.isChecked() || personal.isChecked()) {
                    ...
                    if(btnsave.getText().toString().equals("수정"))  {
                        ...
                        if(titleCheck(title)){
                            ...
                            Toast.makeText(activity_write.this, "해당 날짜에 메모 파일이 있어 정보 수정 모드로 바뀝니다.",Toast.LENGTH_SHORT).show();
                            exist = true;
                            return;
                        }
                        titles.add(title);
                    ...
                    Toast.makeText(getApplicationContext(), "게시글 공유여부를 체크해주세요.", Toast.LENGTH_SHORT).show();
                }
                ...
                alg.setTitle("삭제")
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                adapter.notifyDataSetChanged();
                                tvCount.setText("등록된 이야기 : " + titles.size() +"개");
    ...
    public void writeFile(String title, String body){
        try{
            ...
            bw.close();
            tvCount.setText("등록된 이야기 : " + titles.size() + "개");
            Toast.makeText(this,"저장 완료되었습니다.", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
            e.printStackTrace();
